...
public class CategoryPage extends BasePage{
    ...
    // Element
    private WebElement orderBtn() { return getWebDriver().findElement(_orderBtn); }
    private WebElement firstTitle() { return getWebDriver().findElement(_firstTitle); }
    private WebElement lastTitle() { return getWebDriver().findElement(_lastTitle); }
    //Method
