...
public class Constants {
    ...
    public static final String ARTICLES_MENU = "Articles";
    public static final String COMPONENTS_MENU = "Components";
    public static final String CONTACT_MENU = "Contacts";
    public static final String BANNER_MENU = "Banners";
    public static final String CATEGORIES_ITEM = "Categories";
    public static final String WEBLINK_ITEM = "Web Links";

    //Login Page
    public static final String VALID_USERNAME = "huong";
    ...
    public static final String CATEGORY_CONTACT = "Sample Data-Contact";

    //Banner page
    public static final String CLIENTS_ITEMS = "Clients";
    public static final String SAVE_CLIENTS_SUCCESS = "Client saved.";
    ...
    public static final String SAVE_WEBLINK_SUCCESS= "Web link successfully saved";
    public static final String TRAHS_SUCCESS_WEBLINK = "1 web link successfully trashed.";
